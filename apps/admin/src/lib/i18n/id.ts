...
export const id: Catalog = {
  ...
  'entries.colViews': 'Tampilan',
  'entries.colTrend': 'Perubahan',
  'entries.colShares': 'Klik bagikan',
  'entries.trafficWindow': 'Tampilan, perubahan, dan klik bagikan mencakup {days} hari terakhir.',
  'entries.trafficLink': 'Lihat semua analitik',
  'entries.rowActions': 'Tindakan',
  'entries.actionAnalytics': 'Lihat analitik',
  'entries.actionEdit': 'Ubah entri',
  'entries.actionPreview': 'Pratinjau',
  'entries.actionOpenSite': 'Buka di situs',
  ...
  'media.dropHere': 'Lepaskan berkas untuk mengunggahnya',
  ...
  'upload.progressTitle': 'Mengunggah — {done} dari {total} selesai',
  'upload.finishedTitle': 'Terunggah {done} dari {total}',
  'upload.clearFinished': 'Bersihkan yang selesai',
  'upload.progressAria': 'Kemajuan unggahan {filename}',
  'upload.retryAria': 'Coba lagi {filename}',
  'upload.dismissAria': 'Tutup {filename}',
  'upload.tooLarge': 'Lebih besar dari {size}',
  'upload.unsupportedType': 'Tipe berkas itu tidak dapat diunggah',
  'upload.notAccepted': 'Bukan tipe berkas yang diterima untuk bidang ini',
  'upload.doneOne': 'Berhasil mengunggah {filename}',
  'upload.doneMany': 'Berhasil mengunggah {count} berkas',
  'upload.someFailed': 'Terunggah {count} dari {total} — sisanya tercantum di bawah',
  'upload.allFailed': 'Tidak ada yang terunggah',
  ...
  'analytics.entriesTitle': '10 artikel teratas',
  ...
  'analytics.backToEdit': 'Ubah artikel',
